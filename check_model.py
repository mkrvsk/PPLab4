from dbmodel import Session, User, Moderator, Article, State

def test():
    session = Session()

    user = User(user_id = 1, username = "Oliver", firstname = "Orest", lastname = "Chukla", email="Orest_chukla@ukr.net", password = "1234")
    moderator = Moderator(moderator_id = 1, moderatorname = "Admin", fristname = "Test", lastname = "Test", email="admin@ukr.net", password = "1234", moderatorkey = "1234")
    ...
    state = State(id = 1, name = "Approved")
